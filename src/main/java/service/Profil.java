		...
		try{
			 ...
			 if (session.isNew()){
			        ...
			        if(u.getMon_contrat() == null){
			    		...
			    		ecrire.write("<style>td {vertical-align:top; padding: 200px; padding-top: 100px; width:300px; text-align:left;} .td1{vertical-align:top; }</style>");
			    	...
			    	//	ecrire.write("<div align='left' style=' position:relative;top:20px; left:60px; width:50px;'>");
			    		ecrire.write("<div class='alert alert-success' role='alert' width='300' ><strong>Données personels</strong></div>");
                        ecrire.write(" <h4>Prénom: </h4>"+u.getFirstName());
